...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/public/backgrounds/:filename", controller.GetPublicBackground)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/background/upload", controller.UploadCustomBackground)
		...
		logRoute.GET("/conversation", middleware.AdminAuth(), controller.GetConversationLogs)
