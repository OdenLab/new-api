...
const sensitiveSchema = z.object({
  ...
  ConversationLogEnabled: z.boolean(),
      ...
      <Form {...form}>
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className='space-y-4'>
            ...
            <FormField
              control={form.control}
              name='ConversationLogEnabled'
              render={({ field }) => (
                <SettingsSwitchItem>
                  <SettingsSwitchContent>
                    <FormLabel>
                      {t('Enable conversation history logs')}
                    </FormLabel>
                    <FormDescription>
                      {t(
                        'Stores prompt/response history for admin conversation log review.'
                      )}
                    </FormDescription>
                  </SettingsSwitchContent>
                  <FormControl>
